...
public class AppUserService {
    ...
    public AuthResponseDto register(AppUserRegisterRequestDto request) {
        ...
        return toAuthDto(appUserRepository.save(appUser));
    }
    ...
    public AppUserResponseDto updateStatus(Long id, String status) {
        ...
        if (!normalized.matches("ACTIVE|PENDING|SUSPENDED|INACTIVE|DELETED")) {
    ...
    private AuthResponseDto toAuthDto(AppUser appUser) {
        String roleName = appUser.getRole().getName();
        String token = jwtUtil.generateToken(appUser.getId(), appUser.getEmail(), roleName);
