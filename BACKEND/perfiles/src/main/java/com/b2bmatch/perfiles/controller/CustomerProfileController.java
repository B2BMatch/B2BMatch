...
public class CustomerProfileController {
    ...
    @PostMapping
    public ResponseEntity<CustomerProfileResponse> create(@Valid @RequestBody CustomerProfileRequest request, Authentication authentication) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CustomerProfileResponse> update(@PathVariable Long id, @Valid @RequestBody CustomerProfileRequest request, Authentication authentication) {
